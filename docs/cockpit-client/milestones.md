...
- CoT 推理链工具调用/知识引用丰富化
- 应用构建器 + 文档编辑器面板
- MockCockpitDataSource 全量演示数据
- DDD 依赖方向修复（3 处 domain→application 违规解除）
- 1000 行红线合规（cockpitStore 1797→4 文件、MockCockpitDataSource 1376→3 文件）
...
### 后端对接
- MockCockpitDataSource → HMR API 客户端切换
