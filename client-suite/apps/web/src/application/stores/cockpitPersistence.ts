...
import type { ConversationSession } from './cockpitTypes';

const CONVERSATIONS_KEY = 'cockpit:conversations';
const SESSIONS_KEY = 'cockpit:sessions';
const ACTIVE_CONV_KEY = 'cockpit:activeConversationId';
