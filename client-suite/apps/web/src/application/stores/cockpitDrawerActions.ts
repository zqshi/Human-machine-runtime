/**
 * cockpitDrawerActions —— Drawer + B 栏选择 + Attention 派生
 *
 * 从 cockpitStore 拆分。包含：
 ...
 */
import type { AttentionItem, CockpitDrawerContent } from '../../domain/agent/DrawerContent';
import { useNotificationStore } from './notificationStore';
import type { StoreSet, StoreGet } from './cockpitTypes';

export function drawerActions(set: StoreSet, get: StoreGet) {
  return {
    openDrawer(content: CockpitDrawerContent) {
