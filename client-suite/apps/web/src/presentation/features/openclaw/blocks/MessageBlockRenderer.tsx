      ...
      {blocks.map((block, i) => {
        switch (block.type) {
          ...
          case 'decision-request': {
            const decision = useOpenClawStore
              .getState()
            ...
            return (
              <DecisionRequestCard
                ...
                onDefer={() => {
                  useOpenClawStore.getState().respondDecision(block.decisionId, 'defer', {
          ...
          case 'goal-progress': {
            const goal = useOpenClawStore.getState().goals.find((g) => g.id === block.goalId);
            if (!goal) return null;
            return (
              <button
