...
type Step = 'basic' | 'capabilities' | 'evaluation' | 'version';
...
function buildDefaultPrompt(draft: OrganizationEmployeeCreateDraft): string {
...
function EmptyBlock({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
