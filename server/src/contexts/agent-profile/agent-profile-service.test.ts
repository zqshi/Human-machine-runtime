...
describe('AgentProfileService', () => {
  it('getProfile delegates to portal client', async () => {
    const client = mockPortalClient();
  ...
  it('updateProfile delegates to portal client', async () => {
    const client = mockPortalClient();
    const svc = new AgentProfileService(client as never);
  ...
  it('getJourney delegates to portal client', async () => {
    const client = mockPortalClient();
    const svc = new AgentProfileService(client as never);
  ...
  it('getUsage delegates to portal client', async () => {
    const client = mockPortalClient();
    const svc = new AgentProfileService(client as never);
