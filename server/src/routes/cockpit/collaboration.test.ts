...
import { createCockpitCollaborationRoutes } from './collaboration.js';
...
describe('cockpit collaboration routes', () => {
  it('GET /intents returns intent list (paged)', async () => {
    ...
    const app = createCockpitCollaborationRoutes(repo as never);
